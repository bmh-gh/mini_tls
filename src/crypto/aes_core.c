...
/*
 * T-Tables:
 * Each table represents the output of the MixColumns function (one column each) after the SubByte Function
 * So it replaces the MixColumns and SubBytes
 *
 * Tables for encryption purposes:
 * The columns of each table is a column of the matrix
 * | 02 | 03 | 01 | 01 | |x0|
 * | 01 | 02 | 03 | 01 | |x1|
 * | 01 | 01 | 02 | 03 | |x2|
 * | 03 | 01 | 01 | 02 | |x3|
 * with the substituted value of the input
 * Tenc0 = SBox[x0] o [02, 01, 01, 03]
 * Tenc1 = SBox[x1] o [03, 02, 01, 01]
 * Tenc2 = SBox[x2] o [01, 03, 02, 01]
 * Tenc3 = SBox[x3] o [01, 01, 03, 02]
 *
 * Tables for decryption purposes:
 * | 02 | 03 | 01 | 01 | |x0|
 * | 01 | 02 | 03 | 01 | |x1|
 * | 01 | 01 | 02 | 03 | |x2|
 * | 03 | 01 | 01 | 02 | |x3|
 * with the inverted substituted value of the input
 * Tenc0 = InvSBox[x0] o [02, 01, 01, 03]
 * Tenc1 = InvSBox[x1] o [03, 02, 01, 01]
 * Tenc2 = InvSBox[x2] o [01, 03, 02, 01]
 * Tenc3 = InvSBox[x3] o [01, 01, 03, 02]
 *
 *
 * The tables are the preprocessed functions of MixColumns and SubBytes.
 * They are generated by the script generate_t_tables.py
*/
static const u32 Tenc0[256] = {
        0xc66363a5U, 	0xf87c7c84U, 	0xee777799U, 	0xf67b7b8dU,
        0xfff2f20dU, 	0xd66b6bbdU, 	0xde6f6fb1U, 	0x91c5c554U,
        0x60303050U, 	0x2010103U, 	0xce6767a9U, 	0x562b2b7dU,
        ...
        0x804040cU, 	0x95c7c752U, 	0x46232365U, 	0x9dc3c35eU,
        0x30181828U, 	0x379696a1U, 	0xa05050fU, 	0x2f9a9ab5U,
        0xe070709U, 	0x24121236U, 	0x1b80809bU, 	0xdfe2e23dU,
        ...
        0x8a4545cfU, 	0xe9f9f910U, 	0x4020206U, 	0xfe7f7f81U,
        0xa05050f0U, 	0x783c3c44U, 	0x259f9fbaU, 	0x4ba8a8e3U,
        0xa25151f3U, 	0x5da3a3feU, 	0x804040c0U, 	0x58f8f8aU,
        ...
        0x44222266U, 	0x542a2a7eU, 	0x3b9090abU, 	0xb888883U,
        0x8c4646caU, 	0xc7eeee29U, 	0x6bb8b8d3U, 	0x2814143cU,
        0xa7dede79U, 	0xbc5e5ee2U, 	0x160b0b1dU, 	0xaddbdb76U,
        0xdbe0e03bU, 	0x64323256U, 	0x743a3a4eU, 	0x140a0a1eU,
        0x924949dbU, 	0xc06060aU, 	0x4824246cU, 	0xb85c5ce4U,
        0x9fc2c25dU, 	0xbdd3d36eU, 	0x43acacefU, 	0xc46262a6U,
        0x399191a8U, 	0x319595a4U, 	0xd3e4e437U, 	0xf279798bU,
        0xd5e7e732U, 	0x8bc8c843U, 	0x6e373759U, 	0xda6d6db7U,
        0x18d8d8cU, 	0xb1d5d564U, 	0x9c4e4ed2U, 	0x49a9a9e0U,
        ...
        0x904848d8U, 	0x6030305U, 	0xf7f6f601U, 	0x1c0e0e12U,
        0xc26161a3U, 	0x6a35355fU, 	0xae5757f9U, 	0x69b9b9d0U,
        0x17868691U, 	0x99c1c158U, 	0x3a1d1d27U, 	0x279e9eb9U,
        0xd9e1e138U, 	0xebf8f813U, 	0x2b9898b3U, 	0x22111133U,
        0xd26969bbU, 	0xa9d9d970U, 	0x78e8e89U, 	0x339494a7U,
        0x2d9b9bb6U, 	0x3c1e1e22U, 	0x15878792U, 	0xc9e9e920U,
        0x87cece49U, 	0xaa5555ffU, 	0x50282878U, 	0xa5dfdf7aU,
        0x38c8c8fU, 	0x59a1a1f8U, 	0x9898980U, 	0x1a0d0d17U,
        0x65bfbfdaU, 	0xd7e6e631U, 	0x844242c6U, 	0xd06868b8U,
        0x824141c3U, 	0x299999b0U, 	0x5a2d2d77U, 	0x1e0f0f11U,
        0x7bb0b0cbU, 	0xa85454fcU, 	0x6dbbbbd6U, 	0x2c16163aU

};
static const u32 Tenc1[256] = {
        0xa5c66363U, 	0x84f87c7cU, 	0x99ee7777U, 	0x8df67b7bU,
        0xdfff2f2U, 	0xbdd66b6bU, 	0xb1de6f6fU, 	0x5491c5c5U,
        0x50603030U, 	0x3020101U, 	0xa9ce6767U, 	0x7d562b2bU,
        0x19e7fefeU, 	0x62b5d7d7U, 	0xe64dababU, 	0x9aec7676U,
        0x458fcacaU, 	0x9d1f8282U, 	0x4089c9c9U, 	0x87fa7d7dU,
        0x15effafaU, 	0xebb25959U, 	0xc98e4747U, 	0xbfbf0f0U,
        0xec41adadU, 	0x67b3d4d4U, 	0xfd5fa2a2U, 	0xea45afafU,
        0xbf239c9cU, 	0xf753a4a4U, 	0x96e47272U, 	0x5b9bc0c0U,
        0xc275b7b7U, 	0x1ce1fdfdU, 	0xae3d9393U, 	0x6a4c2626U,
        0x5a6c3636U, 	0x417e3f3fU, 	0x2f5f7f7U, 	0x4f83ccccU,
        0x5c683434U, 	0xf451a5a5U, 	0x34d1e5e5U, 	0x8f9f1f1U,
        0x93e27171U, 	0x73abd8d8U, 	0x53623131U, 	0x3f2a1515U,
        0xc080404U, 	0x5295c7c7U, 	0x65462323U, 	0x5e9dc3c3U,
        0x28301818U, 	0xa1379696U, 	0xf0a0505U, 	0xb52f9a9aU,
        0x90e0707U, 	0x36241212U, 	0x9b1b8080U, 	0x3ddfe2e2U,
        ...
        0xcf8a4545U, 	0x10e9f9f9U, 	0x6040202U, 	0x81fe7f7fU,
        0xf0a05050U, 	0x44783c3cU, 	0xba259f9fU, 	0xe34ba8a8U,
        0xf3a25151U, 	0xfe5da3a3U, 	0xc0804040U, 	0x8a058f8fU,
        0xad3f9292U, 	0xbc219d9dU, 	0x48703838U, 	0x4f1f5f5U,
        0xdf63bcbcU, 	0xc177b6b6U, 	0x75afdadaU, 	0x63422121U,
        0x30201010U, 	0x1ae5ffffU, 	0xefdf3f3U, 	0x6dbfd2d2U,
        ...
        0xdb924949U, 	0xa0c0606U, 	0x6c482424U, 	0xe4b85c5cU,
        0x5d9fc2c2U, 	0x6ebdd3d3U, 	0xef43acacU, 	0xa6c46262U,
        0xa8399191U, 	0xa4319595U, 	0x37d3e4e4U, 	0x8bf27979U,
        0x32d5e7e7U, 	0x438bc8c8U, 	0x596e3737U, 	0xb7da6d6dU,
        0x8c018d8dU, 	0x64b1d5d5U, 	0xd29c4e4eU, 	0xe049a9a9U,
        0xb4d86c6cU, 	0xfaac5656U, 	0x7f3f4f4U, 	0x25cfeaeaU,
        ...
        0xd8904848U, 	0x5060303U, 	0x1f7f6f6U, 	0x121c0e0eU,
...
static const u32 Tenc2[256] = {
        0x63a5c663U, 	0x7c84f87cU, 	0x7799ee77U, 	0x7b8df67bU,
        0xf20dfff2U, 	0x6bbdd66bU, 	0x6fb1de6fU, 	0xc55491c5U,
        0x30506030U, 	0x1030201U, 	0x67a9ce67U, 	0x2b7d562bU,
        ...
        0x40c0804U, 	0xc75295c7U, 	0x23654623U, 	0xc35e9dc3U,
        0x18283018U, 	0x96a13796U, 	0x50f0a05U, 	0x9ab52f9aU,
        0x7090e07U, 	0x12362412U, 	0x809b1b80U, 	0xe23ddfe2U,
        0xeb26cdebU, 	0x27694e27U, 	0xb2cd7fb2U, 	0x759fea75U,
        0x91b1209U, 	0x839e1d83U, 	0x2c74582cU, 	0x1a2e341aU,
        ...
        0x45cf8a45U, 	0xf910e9f9U, 	0x2060402U, 	0x7f81fe7fU,
        0x50f0a050U, 	0x3c44783cU, 	0x9fba259fU, 	0xa8e34ba8U,
        0x51f3a251U, 	0xa3fe5da3U, 	0x40c08040U, 	0x8f8a058fU,
        0x92ad3f92U, 	0x9dbc219dU, 	0x38487038U, 	0xf504f1f5U,
        0xbcdf63bcU, 	0xb6c177b6U, 	0xda75afdaU, 	0x21634221U,
        0x10302010U, 	0xff1ae5ffU, 	0xf30efdf3U, 	0xd26dbfd2U,
        0xcd4c81cdU, 	0xc14180cU, 	0x13352613U, 	0xec2fc3ecU,
        ...
        0xde79a7deU, 	0x5ee2bc5eU, 	0xb1d160bU, 	0xdb76addbU,
        0xe03bdbe0U, 	0x32566432U, 	0x3a4e743aU, 	0xa1e140aU,
        0x49db9249U, 	0x60a0c06U, 	0x246c4824U, 	0x5ce4b85cU,
        0xc25d9fc2U, 	0xd36ebdd3U, 	0xacef43acU, 	0x62a6c462U,
        0x91a83991U, 	0x95a43195U, 	0xe437d3e4U, 	0x798bf279U,
        0xe732d5e7U, 	0xc8438bc8U, 	0x37596e37U, 	0x6db7da6dU,
        0x8d8c018dU, 	0xd564b1d5U, 	0x4ed29c4eU, 	0xa9e049a9U,
        0x6cb4d86cU, 	0x56faac56U, 	0xf407f3f4U, 	0xea25cfeaU,
        0x65afca65U, 	0x7a8ef47aU, 	0xaee947aeU, 	0x8181008U,
        0xbad56fbaU, 	0x7888f078U, 	0x256f4a25U, 	0x2e725c2eU,
        0x1c24381cU, 	0xa6f157a6U, 	0xb4c773b4U, 	0xc65197c6U,
        0xe823cbe8U, 	0xdd7ca1ddU, 	0x749ce874U, 	0x1f213e1fU,
        0x4bdd964bU, 	0xbddc61bdU, 	0x8b860d8bU, 	0x8a850f8aU,
        0x7090e070U, 	0x3e427c3eU, 	0xb5c471b5U, 	0x66aacc66U,
        0x48d89048U, 	0x3050603U, 	0xf601f7f6U, 	0xe121c0eU,
...
static const u32 Tenc3[256] = {
        0x6363a5c6U, 	0x7c7c84f8U, 	0x777799eeU, 	0x7b7b8df6U,
        0xf2f20dffU, 	0x6b6bbdd6U, 	0x6f6fb1deU, 	0xc5c55491U,
        0x30305060U, 	0x1010302U, 	0x6767a9ceU, 	0x2b2b7d56U,
        ...
        0x4040c08U, 	0xc7c75295U, 	0x23236546U, 	0xc3c35e9dU,
        0x18182830U, 	0x9696a137U, 	0x5050f0aU, 	0x9a9ab52fU,
        0x707090eU, 	0x12123624U, 	0x80809b1bU, 	0xe2e23ddfU,
        0xebeb26cdU, 	0x2727694eU, 	0xb2b2cd7fU, 	0x75759feaU,
        0x9091b12U, 	0x83839e1dU, 	0x2c2c7458U, 	0x1a1a2e34U,
        ...
        0x4545cf8aU, 	0xf9f910e9U, 	0x2020604U, 	0x7f7f81feU,
        0x5050f0a0U, 	0x3c3c4478U, 	0x9f9fba25U, 	0xa8a8e34bU,
        0x5151f3a2U, 	0xa3a3fe5dU, 	0x4040c080U, 	0x8f8f8a05U,
        0x9292ad3fU, 	0x9d9dbc21U, 	0x38384870U, 	0xf5f504f1U,
        0xbcbcdf63U, 	0xb6b6c177U, 	0xdada75afU, 	0x21216342U,
        0x10103020U, 	0xffff1ae5U, 	0xf3f30efdU, 	0xd2d26dbfU,
        0xcdcd4c81U, 	0xc0c1418U, 	0x13133526U, 	0xecec2fc3U,
        ...
        0xdede79a7U, 	0x5e5ee2bcU, 	0xb0b1d16U, 	0xdbdb76adU,
        0xe0e03bdbU, 	0x32325664U, 	0x3a3a4e74U, 	0xa0a1e14U,
        0x4949db92U, 	0x6060a0cU, 	0x24246c48U, 	0x5c5ce4b8U,
        0xc2c25d9fU, 	0xd3d36ebdU, 	0xacacef43U, 	0x6262a6c4U,
        0x9191a839U, 	0x9595a431U, 	0xe4e437d3U, 	0x79798bf2U,
        0xe7e732d5U, 	0xc8c8438bU, 	0x3737596eU, 	0x6d6db7daU,
        0x8d8d8c01U, 	0xd5d564b1U, 	0x4e4ed29cU, 	0xa9a9e049U,
        0x6c6cb4d8U, 	0x5656faacU, 	0xf4f407f3U, 	0xeaea25cfU,
        0x6565afcaU, 	0x7a7a8ef4U, 	0xaeaee947U, 	0x8081810U,
        0xbabad56fU, 	0x787888f0U, 	0x25256f4aU, 	0x2e2e725cU,
        0x1c1c2438U, 	0xa6a6f157U, 	0xb4b4c773U, 	0xc6c65197U,
        0xe8e823cbU, 	0xdddd7ca1U, 	0x74749ce8U, 	0x1f1f213eU,
        0x4b4bdd96U, 	0xbdbddc61U, 	0x8b8b860dU, 	0x8a8a850fU,
        0x707090e0U, 	0x3e3e427cU, 	0xb5b5c471U, 	0x6666aaccU,
        0x4848d890U, 	0x3030506U, 	0xf6f601f7U, 	0xe0e121cU,
        ...
        0x8c8c8f03U, 	0xa1a1f859U, 	0x89898009U, 	0xd0d171aU,
        0xbfbfda65U, 	0xe6e631d7U, 	0x4242c684U, 	0x6868b8d0U,
        0x4141c382U, 	0x9999b029U, 	0x2d2d775aU, 	0xf0f111eU,
